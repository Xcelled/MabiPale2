...
namespace MabiPale2.Plugins.EntityLogger.Entities
{
	...
	public class Creature : Entity
	{
		...
		[DependsOn("LifeMaxBase", "LifeMaxMod", "LifeRaw")]
		public float Life { get { return Math.Min(LifeMax, LifeRaw); } }
		...
		public static void Parse(Packet packet, Creature creature)
		{
			creature.EntityId = packet.GetLong();
